...
class CodeBlockRenderer(MarkdownRenderer):
...
class TableRenderer(MarkdownRenderer):
...
def get_renderer(render_type: MarkdownRenderType) -> MarkdownRenderer:
    ...
    """
    renderer_map: dict[MarkdownRenderType, type[MarkdownRenderer]] = {
